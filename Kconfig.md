...
GPIO 34, 35, 36, 39.
Важно: Для них внешняя подтяжка к 3.3В обязательна, если ваш энкодер типа "открытый коллектор".
...
pcnt_chan_config_t chan_z_config = {
    .edge_gpio_num = CONFIG_PCNT_PIN_Z, // Будет либо номер пина, либо -1
    // ...
};
```
